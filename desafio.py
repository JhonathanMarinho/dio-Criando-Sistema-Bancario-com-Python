...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\nValor de saldo não é suficiente. ")
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if execedeu_limite:
            print("\n Valor saque excede o limite. ")
            
        elif execedeu_saques:
            print("\n Numero limite de saques diario excedido.")
...
def recuperar_conta_cliente(cliente):
    ...
    # FIXME: cão permite cliente escolher a conta
...
def exibir_extrato(clientes):
    ...
    extrato = ""
    if not transacoes:
        extrato = "Não fpram realizadas movimentações."
    else:
...
def criar_cliente(clientes):
    ...
    if cliente:
        print("\n Já existe clioente com esse CPF. ")
        return
